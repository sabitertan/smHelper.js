...
// removes an element to the array if it exists using a comparer
// function
...
// Finds index of an object key with giving value
Array.prototype.findKeyIndex = function(key,value){
  return this.map(function(item){return item[key];}).indexOf(value);
};
